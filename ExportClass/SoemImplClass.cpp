...
extern "C"
{
	...
	char IOmap[4096];
	int SoemImplClass::initSlaveInfo(char* ifname) {
		int cnt, i, j, nSM;
		uint16 ssigen;
		int expectedWKC;
	...
	int SoemImplClass::getAdapterNum() {
	...
	int SoemImplClass::getContextInfo(char* adapterName) {
	...
	char ifbuf[1024];
	int SoemImplClass::setNicId(int nicId) {
	...
	int SoemImplClass::initConfig() {
		return 0;
	}

	void SoemImplClass::getSlaveInfo(MySlavet* slave, int id) {
	...
	int SoemImplClass::setIntegerValue(int slaveId, int channel, int value) {
	...
	int SoemImplClass::setDigitValue(int slaveId, int channel, bool value) {
		MySlavet* slave = &my_slave[slaveId];
		int type = slave->type;
